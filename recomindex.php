   ...
   <div class="top_1 clearfix">
	...
	<div class="col-sm-4">
	 <div class="top_1l text-center clearfix">
		 <ul>
		  <li><a href="frontlogin.php"><i class="fa fa-user"></i> Login / Registration</a></li>
		 </ul>
	 </div>
	</div>
	...
	<nav class="navbar">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="recomindex.php"><i class="fa fa-home"></i>VMJMBOE <span>PROPERTY</span></a>
            </div>
